    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preferred_mode', models.CharField(choices=[('developer', 'Developer'), ('student', 'Student'), ('enquiry', 'Enquiry'), ('everyday', 'Everyday'), ('system', 'System')], default='system', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('mode', models.CharField(choices=[('developer', 'Developer'), ('student', 'Student'), ('enquiry', 'Enquiry'), ('everyday', 'Everyday'), ('system', 'System')], max_length=20)),
